...
- **No accreditation registration numbers.** The brief's 1b and 2c asked for CHAS, SafeContractor, SMAS and Constructionline numbers; Ed's instruction is that they are not published. Removed from the accreditations list and from both FAQ answers that mentioned them. Logos and public-register links (SSIP Portal, Constructionline, Companies House) stay; a buyer searches those by company name.
