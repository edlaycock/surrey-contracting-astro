...
export const AUTHOR = {
  firstName: 'Jason',
  surname: '{{JASON_SURNAME}}',
  role: 'Director',
  years: '{{JASON_YEARS}}',
  sectors: '{{JASON_SECTORS}}',
};
export const AUTHOR_NAME = `${AUTHOR.firstName} ${AUTHOR.surname}`;
...
export const SECTIONS: Section[] = [
  {
    id: 'what-groundworks',
    h2: 'What does a groundworks contractor do?',
    body:
      'A groundworks contractor prepares the ground so building can start: strips topsoil, digs and pours foundations, lays drainage and ducting, builds retaining walls and slabs, and gets the site to damp proof course level. Surrey Contracting does all of this in house, including <a href="/earthworks">bulk earthworks and muck away</a>, so there is one contractor on site from the first dig to the slab. See our <a href="/groundworks">groundworks service</a>.',
  },
  {
    id: 'enabling-works',
    h2: 'What are enabling works, and how are they different from groundworks?',
    body:
      'Enabling works are everything that has to happen before the main build can start: <a href="/demolition">demolition</a>, site clearance, asbestos removal coordination, service diversions, temporary access and hoarding. Groundworks then follows on the cleared site. We deliver both, which removes the handover gap between a demolition subcontractor finishing and a groundworks team arriving.',
  },
  {
    id: 'before-demolition',
    h2: 'What do you need before a demolition can start?',
    body:
      'Three things before we can start a demolition in Surrey: a Section 80 demolition notice served on the local authority at least six weeks before work begins, a refurbishment and demolition asbestos survey of the building, and CDM 2015 roles in place (client, principal designer, principal contractor). We handle the notice and the CDM paperwork and work with the client\'s asbestos surveyor on the survey. More on our <a href="/demolition">demolition service</a>.',
  },
  {
    id: 'check-contractor',
    h2: 'How do you check a groundworks or demolition contractor is legitimate?',
    body:
      `Check four things: SSIP accreditation (CHAS or SafeContractor) against the public register, current public liability insurance, an Environment Agency waste carrier registration for muck away, and an active Companies House record. Surrey Contracting Limited is <a href="${COMPANIES_HOUSE_URL}" rel="noopener">company number 15454300</a>. Our CHAS registration is {{CHAS_NUMBER}} and our Constructionline number is {{CONSTRUCTIONLINE_NUMBER}}, both <a href="#accreditations">linked below</a>.`,
  },
];
...
// Second sentence (published cost ranges) is held back until /groundworks-cost exists.
export const COST_ANSWER =
  'Every job is priced after a site visit because ground conditions, access and muck away volumes move the price more than floor area.';

/* ── FAQ. Rendered as <details> and as FAQPage mainEntity from this array. ─── */
export const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'Yes. Surrey Contracting holds CHAS, SafeContractor, SSIP, SMAS Worksafe and Constructionline registrations, and our operatives carry CITB, CSCS, NPORS and IPAF cards. Registration numbers and links to the public registers are in the accreditations section of this page, so you can check each one directly rather than take a logo on trust.',
  },
  {
    q: 'How do I get a quote?',
    a: `Call 01483 323568 or use the form on this page. We respond within one working day, visit the site within ${QUOTE_LEAD_TIME} to check levels, access and services, and the written fixed price quote follows within ${QUOTE_TURNAROUND}. A postcode and a short description of the job are enough to start.`,
  },
];
